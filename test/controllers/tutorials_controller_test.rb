...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { title: @tutorial.title, topic_id: @tutorial.topic_id, tutorial_level: @tutorial.tutorial_level, user_id: @tutorial.user_id }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { title: @tutorial.title, topic_id: @tutorial.topic_id, tutorial_level: @tutorial.tutorial_level, user_id: @tutorial.user_id }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
